...
SUCTION_URDF_PATH = ('diffusha/data_collection/env/assets/suction/'
                     'suction-head-long.urdf')
CYLINDER_URDF_PATH = ('diffusha/data_collection/env/assets/suction/'
                      'cylinder.urdf')
CYLINDER_REAL_URDF_PATH = ('diffusha/data_collection/env/assets/suction/'
                           'cylinder_real.urdf')
